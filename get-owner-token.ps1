# .SYNOPSIS
#   Get a fresh 4-part owner HMAC token for kyleF / steveC / scottD (or the original kyle/scott/steve).
...
function Get-ShortName {
    $valid = @('kyleF','steveC','scottD','kyle','scott','steve')
    while ($true) {
        $choice = Read-Host "Enter owner short name (kyleF / steveC / scottD / kyle / scott / steve) [default: kyleF]"
...
try {
    ...
    Write-Host " - Wrong short name (use kyleF)"
    Write-Host ""
