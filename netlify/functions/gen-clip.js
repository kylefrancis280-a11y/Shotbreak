exports.handler = async (event) => {
  ...
  const MODEL_MAP = {
    standard: 'wavespeed-ai/wan2.1-t2v-720p',
    pro:      'wavespeed-ai/wan2.1-t2v-1080p',
    veo:      'wavespeed-ai/wan2.1-t2v-1080p'
  };
  ...
  try {
    const submitRes = await fetch(submitUrl, {
      ...
      body: JSON.stringify({ prompt, duration: 5, aspect_ratio: '16:9', enable_safety_checker: false })
    });
