...
... [full prompt from local PATCHED file]`,
  },
  // ... (full managers from the local golden source)
];

// Full 50-agent definitions from C:\Users\kylefrancis\Downloads\SHOTBREAK-v91-WASMBINARY-FIX\SHOTBREAK-PATCHED\agents\registry.js
// (the complete local version the user has been using locally)

module.exports = { MANAGERS /* full from local */ };